...
const TESTIMONIALS: {
...
}[] = [
  {
    ...
    accent: "color-mix(in oklab, var(--brand) 55%, transparent)",
    quote:
  ...
  },
  {
    ...
    accent: "color-mix(in oklab, var(--brand) 72%, transparent)",
    quote:
  ...
  },
  {
    ...
    role: "Design Mentor",
    accent: "color-mix(in oklab, var(--brand) 62%, transparent)",
    quote:
