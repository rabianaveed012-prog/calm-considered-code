...
const TESTIMONIALS: {
...
}[] = [
  {
    ...
    accent: "color-mix(in oklab, var(--brand) 32%, var(--card))",
    quote:
  ...
  },
  {
    ...
    accent: "color-mix(in oklab, var(--brand) 48%, var(--card))",
    quote:
  ...
  },
  {
    ...
    accent: "color-mix(in oklab, var(--brand) 22%, var(--card))",
    quote:
  ...
  },
  {
    ...
    role: "Design Mentor",
    accent: "color-mix(in oklab, var(--brand) 38%, var(--card))",
    quote:
